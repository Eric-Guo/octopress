...
cd ~
wget http://cran.r-project.org/src/contrib/shiny_0.8.0.tar.gz
tar xvfz shiny_0.8.0.tar.gz
vi shiny/R/shiny.R # search localhost and replace to your rstudio host name
tar cvf shiny_0.8.0-server.tar.gz shiny
R CMD INSTALL shiny_0.8.0-server.tar.gz
