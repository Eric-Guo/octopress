...
cd ~
wget http://cran.r-project.org/src/contrib/shiny_0.12.1.tar.gz
tar xvfz shiny_0.12.1.tar.gz
vi shiny/R/server.R
...
tar cvfz shiny_0.12.1-server.tar.gz shiny
R CMD INSTALL shiny_0.12.1-server.tar.gz (may need install htmltools before this line)
