...
cd ~
wget http://cran.r-project.org/src/contrib/shiny_0.10.2.tar.gz
tar xvfz shiny_0.10.2.tar.gz
vi shiny/R/server.R
...
tar cvf shiny_0.10.2-server.tar.gz shiny
R CMD INSTALL shiny_0.10.2-server.tar.gz (may need install htmltools before this line)
